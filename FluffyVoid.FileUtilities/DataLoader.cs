...
{
    /// <summary>
    ///     Loads data from a dynamic data path allowing users to define primary and
    ///     fallback data locations
    /// </summary>
    public static class DataLoader
    {
        /// <summary>
        ///     Lookup table of additional fallback paths to use if the primary data path
        ///     fails
        /// </summary>
        ...
        ///     The primary data loader path to use for all IO
        ///     operations
        /// </param>
        /// <param name="fallbackPaths">
        ///     Additional fallback data loader paths to use for
        ///     all IO operations
        /// </param>
        ...
        /// <summary>
        ///     Utility function to try and load a JSON file from disk, prepending the file
        ///     path with DataPath
        /// </summary>
        ...
        ///     Whether the data loader should create a default instance of the data and
        ...
        public static bool LoadJsonData<T>(string filePath,
                                           out T? data,
                                           ...
                                           bool createIfMissing = false)
        {
            ...
            {
                fullFilePath =
                    $"{fallbackPath.GetDataPath(location)}/{filePath}";
        ...
        /// <summary>
        ///     Utility function to try and load a Text file from disk, prepending the file
        ///     path with DataPath
        /// </summary>
        ...
        /// <returns>True if the load operation was successful, otherwise false</returns>
        public static bool LoadTextFile(string     filePath,
                                        out string data,
                                        DataLocation location =
                                            DataLocation.ApplicationData)
        {
        ...
        /// <summary>
        ///     Utility function to try and load an XML file from disk, prepending the file
        ///     path with DataPath
        /// </summary>
        ...
        /// <summary>
        ///     Utility function to try and load a Yaml file from disk, prepending the file
        ///     path with DataPath
        /// </summary>
        ...
        /// <returns>True if the load operation was successful, otherwise false</returns>
        public static bool LoadYaml<T>(string filePath,
                                       out T? data,
                                       DataLocation location =
                                           DataLocation.ApplicationData,
        ...
        /// <summary>
        ///     Utility function to try and save a JSON file to disk, prepending the file
        ///     path with DataPath
        /// </summary>
        ...
        public static bool SaveJsonData<T>(string filePath,
                                           T      data,
                                           DataLocation location =
                                               DataLocation.ApplicationData)
        {
        ...
        /// <summary>
        ///     Utility function to try and save a Text file to disk, prepending the file
        ///     path with DataPath
        /// </summary>
        /// <param name="filePath">Path to the Text file within our Data folder</param>
        ...
        /// <param name="append">
        ///     Determines if the text should be appended to the existing
        ///     file or to overwrite the file
        /// </param>
        public static bool SaveTextFile(string filePath,
                                        string data,
                                        DataLocation location =
                                            DataLocation.ApplicationData,
                                        bool append = false)
        ...
        /// <summary>
        ///     Utility function to try and save a Yaml file to disk, prepending the file
        ///     path with DataPath
        /// </summary>
        ...
        /// <returns>True if the save operation was successful, otherwise false</returns>
        // ReSharper disable once MemberCanBePrivate.Global
        public static bool SaveYamlData<T>(string filePath,
                                           T      data,
                                           DataLocation location =
                                               DataLocation.ApplicationData,
                                           INamingConvention? namingConvention =
        ...
        /// <summary>
        ///     Attempts to find the full file path for the passed in file path by
        ///     iterating over all the loaded and available data
        ///     paths
        /// </summary>
        ...
        ///     The full data path if the path was found in any
        ///     available data loader paths
        /// </param>
        /// <returns>True if the file path exists in any data loader path, otherwise false</returns>
        public static bool TryFindFullPath(string       filePath,
                                           DataLocation location,
        ...
        /// </summary>
        /// <param name="location">
        ///     The data location type to try to find a directory path
        ///     for
        /// </param>
        ...
        /// <returns>
        ///     True if the directory was found for the desired loader type, otherwise
        ///     false
        /// </returns>
        public static bool TryGetLocationPath<TLoader>(DataLocation location,
                                                       out string directoryPath)
        {
            if (s_primaryDataLoaderPath is TLoader)
            {
                directoryPath =
                    $"{s_primaryDataLoaderPath.GetDataPath(location)}";
        ...
        /// <summary>
        ///     Helper function that performs the logic of reading all the text from a text
        ///     file, without logging
        /// </summary>
