...
{
    /// <summary>
    ///     Custom converter for JSON api request payloads for use with the
    ...
    public class JsonHttpPayloadConverter : JsonConverter
    {
        ...
        {
            return typeof(IDictionary<string, object>).IsAssignableFrom(
                objectType);
        }
        /// <summary>
        ...
        /// <summary>
        ///     Helper function used to read out an array type to place into the value of a
        ///     dictionary entry
        /// </summary>
        /// <param name="reader">Reference to the json reader</param>
        ...
        /// <summary>
        ///     Helper function used to read out a dictionary value to place into the value
        ...
        /// <summary>
        ///     Helper function used to read out the varying data types to place into the
        ...
        private void WriteObject(JsonWriter writer, object value)
        {
            ...
            foreach (KeyValuePair<string, object> currentObject in
                     dictionaryObject)
            {
        ...
        /// <summary>
        ///     Helper function used to write the varying data types into a JSON api
        ///     payload
        /// </summary>
        /// <param name="writer">Reference to the json writer</param>
        /// <param name="value">The value to write out</param>
